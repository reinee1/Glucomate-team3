          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              {isEditing ? (
                <Input
                  value={
                    Array.isArray(formData.medicalHistory.medicalConditions)
                      ? formData.medicalHistory.medicalConditions.join(", ")
                      : ""
                  }
                  onChange={(e) =>
                    handleInputChange(
              ...
              <div>
                ...
                {isEditing ? (
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("medicalHistory", "otherCondition", e.target.value)
                    }
                    className="w-full"
                  />
                ) : (
            ...
            <div>
              ...
              {isEditing ? (
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("medicalHistory", "familyHeartDisease", value)
                  }
                >
                  <SelectTrigger className="w-full">
              ...
              <div>
                ...
                {isEditing ? (
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("medicalHistory", "familyMember", e.target.value)
                    }
                    className="w-full"
                  />
                ) : (
            ...
            <div>
              ...
              {isEditing ? (
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("medicalHistory", "takingInsulin", value)
                  }
                >
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Select option" />
                ...
                <div>
                  ...
                  {isEditing ? (
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("medicalHistory", "insulinType", e.target.value)
                      }
                      className="w-full"
                    />
                  ) : (
                ...
                <div>
                  ...
                  {isEditing ? (
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("medicalHistory", "insulinDosage", e.target.value)
                      }
                      className="w-full"
                    />
                  ) : (
                ...
                <div>
                  ...
                  {isEditing ? (
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("medicalHistory", "insulinSchedule", e.target.value)
                      }
                      className="w-full"
                    />
                  ) : (
            ...
            <div>
              ...
              {isEditing ? (
                <Input
                  value={
                    Array.isArray(formData.medicalHistory.allergies)
            ...
            <div>
              ...
              {isEditing ? (
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("lifestyle", "exerciseFrequency", value)
                  }
                >
                  <SelectTrigger className="w-full">
            ...
            <div>
              ...
              {isEditing ? (
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("monitoring", "bloodSugarMonitoring", value)
                  }
                >
                  <SelectTrigger className="w-full">
            ...
            <div>
              ...
              {isEditing ? (
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("monitoring", "hba1cReading", e.target.value)
                  }
                  className="w-full"
                />
              ) : (
              ...
              <div>
                ...
                {isEditing ? (
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("monitoring", "cgmFrequency", e.target.value)
                    }
                    className="w-full"
                  />
                ) : (
            ...
            <div>
              ...
              {isEditing ? (
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("monitoring", "frequentHypoglycemia", value)
                  }
                >
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Select option" />
              ...
              <div>
                ...
                {isEditing ? (
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("monitoring", "hypoglycemiaFrequency", e.target.value)
                    }
                    className="w-full"
                  />
                ) : (
